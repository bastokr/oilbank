...
class ChatPageState extends State<ChatPage> {
  ...
  void readLocal() {
    ...
    /*채팅중사용자만 표시*/
    chatProvider.addCallactionDataFirestore(
        FirestoreConstants.pathUserCollection, currentUserId, peerId);
    chatProvider.addCallactionDataFirestore(
        FirestoreConstants.pathUserCollection, peerId, currentUserId);
  }
