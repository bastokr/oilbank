...
import 'package:oilstock/utils/utils.dart';
...
class ChatList extends StatefulWidget {
  const ChatList({Key? key, required String title}) : super(key: key);
...
class ChatListState extends State<ChatList> {
  ...
  void showNotification(RemoteNotification remoteNotification) async {
    AndroidNotificationDetails androidPlatformChannelSpecifics =
      ...
      Platform.isAndroid ? 'com.shsoft.ybauction' : 'com.duytq.flutterchatdemo',
      'Flutter chat demo',
      playSound: true,
                ...
                children: [
                  ...
                  Expanded(
                    child: StreamBuilder<QuerySnapshot>(
                      stream: homeProvider.getStreamFireStoreWidthID(
