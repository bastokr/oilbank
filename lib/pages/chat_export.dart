...
import 'package:oilstock/providers/providers_export.dart';
...
class ChatExport extends StatefulWidget {
  ChatExport({Key? key, required this.arguments}) : super(key: key);

  final ChatPageArguments arguments;

  @override
  ChatExportState createState() => ChatExportState();
}

class ChatExportState extends State<ChatExport> {
  ...
  late ChatProviderExport chatProvider;
  late AuthProvider authProvider;

  @override
  void initState() {
    super.initState();
    chatProvider = context.read<ChatProviderExport>();
