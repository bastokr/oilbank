...
class ShipMain extends StatefulWidget {
  final token;
  final user_id;
  const ShipMain(this.token, this.user_id, {Key? key}) : super(key: key);

  @override
  _WebViewExampleState createState() => _WebViewExampleState();
}

class _WebViewExampleState extends State<ShipMain> {
    ...
    return Scaffold(
        ...
        body: Builder(builder: (BuildContext context) {
          ...
          return WillPopScope(
              ...
              child: WebView(
                //initialUrl:
                //    'https://luckytransportca.cafe24.com/mrfact/custom/main_and.php?site=A',
                ...
                onWebViewCreated: (WebViewController webViewController) {
                  ...
                  webViewController.loadUrl(
                      'https://luckytransportca.cafe24.com/mrfact/custom/ship_and.php?site=M',
                      headers: {
